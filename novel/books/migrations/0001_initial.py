# Generated by Django 3.2.13 on 2022-05-07 09:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view_count', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='View Count')),
                ...
                ('visit', models.CharField(blank=True, choices=[('webnovel', 'Webnovel'), ('pandanovel', 'Pandanovel'), ('other', 'Other')], default='webnovel', max_length=55)),
                ...
                ('revisit', models.CharField(blank=True, choices=[('webnovel', 'Webnovel'), ('pandanovel', 'Pandanovel'), ('other', 'Other')], default='webnovel', max_length=55)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin', models.CharField(blank=True, choices=[('webnovel', 'Webnovel'), ('pandanovel', 'Pandanovel'), ('other', 'Other')], default='', max_length=55)),
